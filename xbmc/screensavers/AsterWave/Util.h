...
inline Color AddColor2(Color s,Color e,float r) {
  s.r+=(unsigned char)(e.r*r);
  s.g+=(unsigned char)(e.g*r);
  s.b+=(unsigned char)(e.b*r);
  return s;
};
inline Color LerpColor2(Color s,Color e,float r) {
  Color temp;
  temp.r=temp.b=temp.g=0;
  temp.r=(unsigned char)(s.r*(1.0f-r)+e.r*r);
  temp.g=(unsigned char)(s.g*(1.0f-r)+e.g*r);
  temp.b=(unsigned char)(s.b*(1.0f-r)+e.b*r);
  return temp;
};
